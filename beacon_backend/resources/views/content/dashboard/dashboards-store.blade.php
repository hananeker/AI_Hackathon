  ...
  <div class="col-lg-8 mb-4 order-0">
    <div class="card">
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            <h5 class="card-title text-primary">Welcome {{Auth::guard('admin')->check() ? Auth::guard('admin')->user()->name : Auth::guard('store')->user()->name}}! 🎉</h5>
      ...
      <div class="col-lg-6 col-md-12 col-6 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="card-title mb-2">{{Auth::guard('store')->user()->points}}</h3>
            <small class="text-success fw-semibold">In solde</small>
          </div>
        </div>
      </div>
      <!-- Sales Card -->
