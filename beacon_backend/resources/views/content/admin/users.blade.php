    ...
    <div class="table-responsive text-nowrap">
        <table class="table table-hover">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    <td style="max-width: 10em;"><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{$user->name}}</strong></td>
                    <td style="max-width: 10em;">{{$user->email}}</td>

                    <td style="max-width: 10em;"><span class="badge bg-label-{{($user->status == 'active') ? 'primary' : 'danger'}}">{{$user->status}}</span></td>
