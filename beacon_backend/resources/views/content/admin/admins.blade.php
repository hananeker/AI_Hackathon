...
<div class="card">
    <div class="container">
        <div class="row row-cols-2">
            ...
            <div class="col-2 col-md-2"><button type="button" class="btn btn-primary" style="margin-top: 1em;" data-bs-toggle="modal" data-bs-target="#basicModal"><span class="tf-icons bx bx-plus"></span>Add Admin</button></div>
            <!-- Modal -->
            <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form class="modal-content" action="{{route('createAdmin')}}" method="POST">
                        @csrf
    ...
    <div class="table-responsive text-nowrap">
        <table class="table table-hover">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    <td style="max-width: 10em;"><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{$admin->name}}</strong></td>
                    <td style="max-width: 10em;">{{$admin->email}}</td>

                    <td style="max-width: 10em;"><span class="badge bg-label-primary me-1">Active</span></td>
