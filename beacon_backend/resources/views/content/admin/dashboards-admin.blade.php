          ...
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
              <div class="avatar flex-shrink-0">
                <img src="{{asset('assets/img/icons/unicons/points.png')}}" alt="chart success" class="rounded">
              </div>
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                  <a class="dropdown-item" href="javascript:void(console.log('Hello'));">Edit</a>
                </div>
              </div>
            </div>
            <span class="fw-semibold d-block mb-1">Points</span>
            <h3 class="card-title mb-2">{{$configData->pointsPerStore}}</h3>
            <small class="text-success fw-semibold">Per Store</small>
          </div>
        </div>
      </div>
      <!-- Sales Card -->
      <div class="col-lg-6 col-md-12 col-6 mb-4">
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
              <div class="avatar flex-shrink-0">
                <img src="{{asset('assets/img/icons/unicons/store.png')}}" alt="Credit Card" class="rounded">
              </div>
              <div class="dropdown">
            ...
            <span>Stores</span>
            <h3 class="card-title text-nowrap mb-1">{{$countStores}}</h3>
